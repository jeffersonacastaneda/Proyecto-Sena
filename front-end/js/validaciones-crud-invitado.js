import {limpiarCamposInvitado,validarBusquedaInvitado, llenarTablaInvitado,} from "./validaciones-invitado.js";


//GEASTION DE BUSQUEDA PARA UN USUARIO INVITADO

document.getElementById("btn-invitado").addEventListener("click", function (event) {
  ...
  // Evita el envío automático del formulario
    ...
    if (isValid) {
      ...
      fetch(`/libros/buscar-invitado?${queryString}`, {
        ...
        .catch((error) => {
          // alert("No se encontró ningún libros con los criterios especificados.");
        });
    }
  });
